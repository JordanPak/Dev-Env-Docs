...
# BY JORDAN: ADD COMPOSER TO PATH
...
# Remove prompt user/host
prompt_context() {}

# Set xDebug IDE key
export XDEBUG_CONFIG="idekey=VVVDEBUG"
...
# Use arm64-compatible Chromium (for Puppeteer)
export PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true
export PUPPETEER_EXECUTABLE_PATH=`which chromium`

# pyenv (@see https://github.com/pyenv/pyenv?tab=readme-ov-file#set-up-your-shell-environment-for-pyenv)
export PYENV_ROOT="$HOME/.pyenv"
[[ -d $PYENV_ROOT/bin ]] && export PATH="$PYENV_ROOT/bin:$PATH"
eval "$(pyenv init -)"

# Lando
export PATH="/Users/jpakrosnis/.lando/bin${PATH+:$PATH}"; #landopath
